    ...
    <>
      <div className={style.amazon_items}>
        <ul className={style.amazon_items_ul}>
          ...
          <li className={`${style.amazon_items_li} ${style.amazon_items_li_hover}`}> Kitchen & Home Appliances
          ...
          <li className={style.amazon_items_li}>Furniture</li>
          <li className={style.amazon_items_li}>Home Furnishing</li>
