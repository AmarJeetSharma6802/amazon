...
export default function Home() {
  ...
  const imagePath = [
    {
      ...
      image: [
        ...
        {
          img: "https://m.media-amazon.com/images/I/71bagLp2sXL._AC_UY327_FMwebp_QL65_.jpg",
          id: 2,
          navigate:"/laptop"
        },
    ...
    },
    {
      ...
      imgTitle1: "Cushion covers, bedsheets & more",
    ...
    },
    {
      ...
      image: [
        ...
        },
        {
          ...
          id: 10,
          name: "Starting ₹649 | boult",
        },
       { img:"https://images-eu.ssl-images-amazon.com/images/G/31/img21/june/CE/MSO/PD3/PC_QuadCard_Zeb_0.5x_1._SY116_CB570220221_.jpg",
        id:11,
        name:"Starting ₹349 | Noise "
       },
    ...
    {
      id: 4,
      imgTitle1: "Cleaning accessories",
    ...
    {
      id: 5,
      imgTitle1: "Starting ₹199 | Bedsheets",
    ...
    {
      id: 7,
      imgTitle1: "Under ₹199 | Cleaning supplies",
      ...
      image: [
       ...
       {img: "https://images-eu.ssl-images-amazon.com/images/G/31/img18/HomeImprovement/harsmisc/2025/March/Tools_low_res_V1._SY116_CB549138744_.jpg",},
    ...
    {
      id: 8,
      imgTitle1: "Min. 40% off | soft toys",
      ...
      image: [
       {img: "https://images-eu.ssl-images-amazon.com/images/G/31/img21/AmazonBrands/GW_CPB_/QC_CC/Baby_toys/baby/QC_PC_186x116_9._SY116_CB563558900_.jpg",},
       { img:"https://images-eu.ssl-images-amazon.com/images/G/31/img21/AmazonBrands/GW_CPB_/QC_CC/Baby_toys/toys/QC_PC_186x116_22._SY116_CB541411275_.jpg",},
        {img:"https://images-eu.ssl-images-amazon.com/images/G/31/img21/AmazonBrands/GW_CPB_/QC_CC/Baby_toys/toys/QC_PC_186x116_13._SY116_CB541414575_.jpg",},
        {img:"https://images-eu.ssl-images-amazon.com/images/G/31/img21/AmazonBrands/GW_CPB_/QC_CC/Baby_toys/toys/QC_PC_186x116_16._SY116_CB541411275_.jpg",}
      ],
    },
  ];
  ...
  const itemMember = [
    ...
    },
    {
      ...
      price: "₹ 13,499.00",
      details:
        "iQOO Z10 5G (Glacier Silver, 8GB RAM, 256GB Stroage) | India's Biggest Ever 7300 mAh Battery",
              ...
              <div className={style.grid_flex_item_main_title}>
                ...
                <div className={style.grid_flex_item_title}>
                  {item.image.map((img, index) => (
                    ...
                    >
                      {typeof item === "object" && img.navigate ?(
                        <Link href={`innerItems/${img.navigate}`}>
                        <Image
                          src={img.img}
                              alt={img.name || "image"}
                          width={155}
